...
.PHONY: build
build:
	docker build -t digitalmarketplace-aws-search-api-http --build-arg DM_APP_NAME=search-api -f docker-aws/Dockerfile.http .
	docker build -t digitalmarketplace-aws-search-api-wsgi -f docker-aws/Dockerfile.wsgi .
